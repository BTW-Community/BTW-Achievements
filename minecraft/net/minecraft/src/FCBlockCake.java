...
public class FCBlockCake extends BlockCake
{
    ...
    public void SetRedstoneOn( World world, int i, int j, int k, boolean bOn )
    {
        ...
        List nearbyPlayers = world.getEntitiesWithinAABB( EntityPlayer.class, possessionBox );
           
        Iterator creatureIterator = nearbyPlayers.iterator();
       	
        while ( creatureIterator.hasNext() )
        {
        	EntityPlayer tempPlayer = (EntityPlayer)creatureIterator.next();
           	EventDispatcher.onCakePowered(tempPlayer, this);
        }
    }
