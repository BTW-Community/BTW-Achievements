...
public class EventDispatcher {
	...
	public static void onEaten(EntityPlayer player, ItemStack stack) {
		handleEvent(EventType.EATEN, player, stack);
		
	}

	public static void onCakePowered(EntityPlayer player, FCBlockCake fcBlockCake) {
		handleEvent(EventType.POWERCAKE, player, fcBlockCake);
